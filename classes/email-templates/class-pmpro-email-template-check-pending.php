...
class PMPro_Email_Template_Check_Pending extends PMPro_Email_Template {
	...
	public static function get_template_name() {
		return esc_html__( 'Pay By Check - Check Pending', 'pmpro-pay-by-check' );
	}
	...
	public static function get_template_description() {
		return esc_html__( 'This email is sent to a member when an Pay By Check order is created in "pending" status.', 'pmpro-pay-by-check' );
	}	
 ...
 */
function pmproet_email_templates_check_pending( $email_templates ) {
	$email_templates['check_pending'] = 'PMPro_Email_Template_Check_Pending';

	return $email_templates;
}
add_filter( 'pmpro_email_templates', 'pmproet_email_templates_check_pending' );