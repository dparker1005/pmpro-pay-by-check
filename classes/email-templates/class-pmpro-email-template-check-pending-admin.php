...
class PMPro_Email_Template_Check_Pending_Admin extends PMPro_Email_Template {
	...
	public static function get_template_name() {
		return esc_html__( 'Pay By Check - Check Pending (admin)', 'pmpro-pay-by-check' );
	}
	...
	public static function get_template_description() {
		return esc_html__( 'This email is sent to the site administrator when a Pay By Check order is created in "pending" status.', 'pmpro-pay-by-check' );
	}	
 ...
 */
function pmproet_email_templates_check_pending_admin( $email_templates ) {
	$email_templates['check_pending_admin'] = 'PMPro_Email_Template_Check_Pending_Admin';

	return $email_templates;
}
add_filter( 'pmpro_email_templates', 'pmproet_email_templates_check_pending_admin' );